...
void loop() {
  ...
  //----------Control Multiple Pins/ LEDs----------// 
       ...
       if(voice == "*Blue" || voice =="*blue")//                                FOR RED COLOUR OF THE LED 
     {
     analogWrite(RED,0); 
     analogWrite(GREEN,0);
     analogWrite(BLUE,255);
     }  
  else if(voice == "*Green" || voice =="*green")//                              FOR GREEN COLOUR OF THE LED !
     {
    analogWrite(GREEN,255);
    analogWrite(RED,0);
    analogWrite(BLUE,0);
     }
  else if(voice == "*Red" || voice == "*red")//                                FOR BLUE COLOUR OF THE LED !
     {
    analogWrite(RED,255);
    analogWrite(BLUE,0);
    analogWrite(GREEN,0);
  ...
  else if(voice == "*White" || voice == "*white")//                               FOR WHITE COLOUR OF THE LED !
     {
    analogWrite(RED,255);
    analogWrite(GREEN,255);
    analogWrite(BLUE,255);
